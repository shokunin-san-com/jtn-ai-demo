...
元データ: `demo1_kyk/templates/KYKシート.xlsx`（リポジトリ内）
...
元データ: `demo2_sekou_keikaku/templates/` `demo2_sekou_keikaku/reference/`（リポジトリ内）
...
元データ: `demo3_geppo/templates/` `demo3_geppo/reference/`（リポジトリ内）
